...
accessible through the :func:`risktools.data.open_data` function. These datasets
...
Used by :func:`swap_com` and :func:`swap_fut_weight` to calculate calendar month
average weights.
...
Used as input to :func:`swap_irs` for interest rate swap pricing.
...
Used by :func:`chart_eia_sd` to build supply/demand balance charts.
...
See :doc:`api_data` for full function documentation.
